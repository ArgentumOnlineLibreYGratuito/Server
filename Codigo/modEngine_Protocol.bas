...
Public Sub Handle(ByVal Connection As Network_Client, ByVal Message As BinaryReader)
    ...
    Select Case PacketID
        ...
        Case ClientPacketID.ResetAutoUpdate         '/AUTOUPDATE
            Call HandleResetAutoUpdate(Message, UserIndex)
...
Private Sub HandleLoginExistingChar(ByVal Message As BinaryReader, ByVal UserIndex As Integer)
    ...
    UserList(UserIndex).flags.NoActualizado = Not VersionesActuales(Message.ReadInt(), Message.ReadInt(), Message.ReadInt(), Message.ReadInt(), Message.ReadInt(), Message.ReadInt(), Message.ReadInt())
...
Public Sub HandleResetAutoUpdate(ByVal Message As BinaryReader, ByVal UserIndex As Integer)
